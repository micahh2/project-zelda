...
public interface GraphicSystem
{
    ...
    void drawRect(int xAbs, int yAbs, int width, int height, int strokeWidth, Color color);
    void drawRoundRect(int xAbs, int yabs, int width, int height, int arcWidth, int arcHeight, int strokeWidth, Color color);

    void fillRect(int xAbs, int yAbs, int width, int height, Color color);
    void fillRoundRect(int xAbs, int yabs, int width, int height, int arcWidth, int arcHeight, Color color);
    ...
    void drawOval(int xAbs, int yAbs, int r1, int r2, int strokeWidth, Color color);

    void fillOval(int xAbs, int yAbs, int r1, int r2, Color color);

    // For drawing with relative screen coordinates
    void drawRectScreen(int x, int y, int width, int height, int strokeWidth, Color color);
    void drawRoundRectScreen(int x, int y, int width, int height, int arcWidth, int arcHeight, int strokeWidth, Color color);

    void fillRectScreen(int x, int y, int width, int height, Color color);
    void fillRoundRectScreen(int x, int y, int width, int height, int arcWidth, int arcHeight, Color color);

    void drawOvalScreen(int x, int y, int r1, int r2, int strokeWidth, Color color);
