...
public class RPGWorld extends World {
    ...
    public void init() {
        ...
        mainMenuObjects.add(new UIImage(worldWidth/2-gameOverRef.x2/2, (int)(worldHeight*0.1), gameOverRef));
        mainMenuObjects.add(new UIImage(worldWidth/2-gameCompleteRef.x2/2, (int)(worldHeight*0.1), gameCompleteRef));
